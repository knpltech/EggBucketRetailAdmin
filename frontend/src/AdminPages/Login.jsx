      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 max-w-5xl w-full bg-white bg-opacity-10 rounded-xl shadow-lg overflow-hidden">
        <div className="p-8 text-white hidden md:flex flex-col justify-center bg-gradient-to-br from-blue-700 to-purple-700">
          ...
          <p className="text-lg mb-6">
            Your central dashboard for managing retail partners, delivery
            partners, tracking customer info, and handling business insights.
          </p>
          ...
          <div className="mb-4 flex space-x-4">
            ...
            <label className="text-gray-700 font-medium">
              <input
                type="radio"
                value="supervisor"
                checked={loginType === "supervisor"}
                onChange={() => setLoginType("supervisor")}
                className="mr-2"
              />
              Supervisor
            </label>
            <label className="text-gray-700 font-medium">
              <input
                type="radio"
                value="admin-view"
                checked={loginType === "admin-view"}
                onChange={() => setLoginType("admin-view")}
                className="mr-2"
              />
              Admin-View
            </label>
